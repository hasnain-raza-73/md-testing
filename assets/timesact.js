    ...
    timesactScriptNew = async function ($) {
        ...
        class TimesactButton {
            ...
            showBIS(settings) {
                ...
                if (this.hasInsideSpan) {
                    $(this.addToCartButtonSelector).parent().attr('style', `display: none !important;`)
                } else {
                    $(this.addToCartButtonSelector).attr('style', `display: none !important;`)
                }
            }
        ...
        class TimesactEventListener {
            initVariantEventListener(preorder) {
                var event = this;
                ($(document).on("click", ".pdp__content__swatches__item", function (e) {
                    event.variantChangeHandler(preorder, e);
                }),
            ...
            variantChangeHandler(preorder, e) {
                ...
                this.sleep(preorder.selectors.variantChangingTime).then(function () {
                    ...
                    preorderEntry.product.setActiveVariant(selectedVariant.id);
